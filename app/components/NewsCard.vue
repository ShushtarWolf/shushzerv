...
const accent = computed(() => resolveAccent(props.article.sport))
</script>
...
<template>
  ...
  >
    ...
    <div class="flex flex-1 flex-col p-5">
      ...
      <span class="mt-3 inline-block text-sm font-medium transition-colors duration-200" :style="{ color: accent }">
